...
(function(){
  ...
  str += "<iframe frameborder='0' scrolling='no' name='google_sheets_bookmarklet_iframe' id='google_sheets_bookmarklet_iframe' src='" + iframe_url + "' width='550px' height='275px' style='textalign:right; backgroundColor: white;'></iframe>";
